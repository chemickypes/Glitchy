package me.bemind.sidemenu;

/**
 * Created by angelomoroni on 04/01/16.
 */
 ...
 *
 * <p>To use <code>SideMenuToggle</code>, create one in your Activity and call through
 ...
 * has occurred.</p>
 *
 * <p><code>SideMenuToggle</code> can be used directly as a
 ...
 * ActionBar theme.
 */
public class SideMenuToggle implements SideMenu.PanelSlideListener{
    /**
     * Allows an implementing Activity to return an {@link SideMenuToggle.Delegate} to use
     * with SideMenuToggle.
     */
    ...
    private final SideMenu mDrawerLayout;
    ...
    /**
     * Construct a new SideMenuToggle.
     *
     * <p>The given {@link Activity} will be linked to the specified {@link SideMenu} and
     ...
     *                                  for accessibility
     */
    public SideMenuToggle(Activity activity, SideMenu drawerLayout,
    ...
    /**
     * Construct a new SideMenuToggle with a Toolbar.
     * <p>
     * The given {@link Activity} will be linked to the specified {@link SideMenu} and
     ...
     * <p>
     * Please use {@link #SideMenuToggle(Activity, SideMenu, int, int)} if you are
...
//            mActivityImpl = new HoneycombDelegate(activity);
     ...
     * may have diverged in such a way that the SideMenuToggle was not notified.
...
//                        mDrawerLayout.isDrawerOpen(GravityCompat.START) ?
    ...
    /**
     * {@link SideMenu} callback method. If you do not use your
     * SideMenuToggle instance directly as your SideMenu's listener, you should call
     ...
     */
    @Override
    public void onPanelSlide(View drawerView,View bottomPanel, float slideOffset) {
     ...
     */
    @Override
    public void onPanelOpened(View drawerView,View bottomPanel) {
        mSlider.setPosition(1);
        if (mDrawerIndicatorEnabled) {
     ...
     */
    @Override
    public void onPanelClosed(View drawerView,View bottomPanel) {
        mSlider.setPosition(0);
        if (mDrawerIndicatorEnabled) {
...
//    }
    ...
    void setActionBarUpIndicator(Drawable upDrawable, int contentDescRes) {
        if (!mWarnedForDisplayHomeAsUp && !mActivityImpl.isNavigationVisible()) {
            Log.w("SideMenuToggle", "DrawerToggle may not show up because NavigationIcon"
