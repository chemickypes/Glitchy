...
object EffectList{
    ...
    init {
        data.add(EffectView(Effect.GLITCH,R.string.glitch,R.layout.effect_glitch_layout,EFFECT_NEWS.NEW))
        ...
        data.add(EffectView(Effect.SWAP,R.string.swap,R.layout.effect_glitch_layout,EFFECT_NEWS.NEW))
        data.add(EffectView(Effect.GHOST,R.string.ghost,R.layout.effect_ghost_layout,EFFECT_NEWS.PRO))
